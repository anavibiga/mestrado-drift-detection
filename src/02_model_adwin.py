...
def drift_detection_on_ma(ma_values, params, cooldown_minutes=10, warmup_minutes=0, window_ma=10):
    ...
    Mesma lógica de janela inicial que o v4/v5 (só alimenta após window_ma amostras), ou seja, window_ma opera como warmup, por isso warmup = 0.
    """
